...
public class WekaToSamoaInstanceConverter implements Serializable{
     ...
     * @return the instance
     */
    public Instance samoaInstance(weka.core.Instance inst, boolean withClassValue) {
     ...
     * @return the instances
     */
    public Instances samoaInstances(weka.core.Instances instances, boolean withClassAttribute) {
        ...
        for (int i = 0; i < instances.numInstances(); i++) {
            samoaInstances.add(samoaInstance(instances.instance(i), withClassAttribute));
        }
        return samoaInstances;
    }
