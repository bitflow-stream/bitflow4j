...
public class PipelineConstructorRegistryTest {
    ...
    private <T> T constructTestStep(String stepName, Map<String, Object> params) throws ConstructionException {
        RegisteredStep registration = registry.getRegisteredStep(stepName);
        assertNotNull(registration);
        return (T) registration.instantiate(registration.parameters.parseRawParameters(params));
    }
    ...
    @Test
    public void testNormalStepConstruction() throws ConstructionException {
    ...
    @Test
    public void testUseMarkedConstructor() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("intArg", "5");
    ...
    @Test
    public void testUnmarkedConstructorDoesNotWork() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("intArg", "5");
        params.put("doubleArg", "5.5");
    ...
    @Test
    public void testSingleConstructor() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("intArg", "5");
    ...
    @Test
    public void testOptional_allParameters() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
    ...
    @Test
    public void testOptional_someMissingParameters() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("requiredArg", "567");
        params.put("intArg", "5");
        params.put("boolArg", "FALSE");
    ...
    @Test
    public void testOptional_onlyRequiredParameter() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("requiredArg", "567");
    ...
    @Test
    public void testOptional_missingRequiredParameter() throws ConstructionException {
        Map<String, Object> params = new HashMap<>();
        params.put("intArg", "5");
        params.put("boolArg", "FALSE");
        params.put("floatArg", "200.5");
